...
class CNN_LSTM(nn.Module):
    ...
    """
    def __init__(self,input_size=3,hidden_size=256,num_layers=4,num_classes=5,dropout_1=0.3,dropout_2=0.3,input_length=200):
        ...
        self.cnn3=nn.Conv1d(in_channels=hidden_size,out_channels=128,kernel_size=3)
        #lout=184-8=176
        ...
        self.dense1=nn.Linear(in_features=128,out_features=num_classes)
