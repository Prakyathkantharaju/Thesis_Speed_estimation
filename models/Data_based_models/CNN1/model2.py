...
class CNN(nn.Module):
    def __init__(self,input_features=3,input_length=200,num_classes=5,dropout=0.1):
        ...
        self.conv1=nn.Conv1d(in_channels=self.in_channels,out_channels=64,kernel_size=7,stride=1,padding=2)
        ...
        self.conv4=nn.Conv1d(in_channels=256,out_channels=256,kernel_size=9,stride=1,padding=2)
        # lout = 174
        ...
        self.conv5=nn.Conv1d(in_channels=256,out_channels=128,kernel_size=10,stride=1,padding=2)
        # lout = 78 
