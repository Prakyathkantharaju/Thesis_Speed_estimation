...
def split(data,label,window=4,interval=0.25,sample_rate=148,vel_pos_flag=False,vert_acc_i=1):
...
def preprocess():
    ...
    for i in map.keys():
        ...
        x,y=split(data,map[i],window=win,sample_rate=200,vert_acc_i=0)
