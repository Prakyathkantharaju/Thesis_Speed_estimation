...
class CNN(nn.Module):
    def __init__(self,input_features=1,input_length=200,num_classes=5,dropout=0.1):
        ...
        self.conv4=nn.Conv1d(in_channels=256,out_channels=256,kernel_size=7,stride=1,padding=2)
        # lout = 174
        self.lout4=self.lout3-8
        self.maxpool1=nn.MaxPool1d(kernel_size=2,stride=2)
        # lout= 87
        self.lout4=(self.lout4-2)/2 + 1
        self.batchnorm4=nn.BatchNorm1d(num_features=256)

        self.conv5=nn.Conv1d(in_channels=256,out_channels=128,kernel_size=7,stride=1,padding=2)
        # lout = 78 
        ...
        self.dense1=nn.Linear(in_features=int(128*4),out_features=num_classes)
